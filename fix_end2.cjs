...
const cutIndex = code.lastIndexOf(')}'); // Find the end of AnimatePresence block
// Actually let's just replace the whole thing using substring.

let startOfAnim = code.lastIndexOf('</Anim      {/* FIXED BOTTOM NAV DOCK */}');
if (startOfAnim !== -1) {
